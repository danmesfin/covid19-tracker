...
export default function Index() {
  ...
  return (
    <div className="grid grid-cols-1 mt-3 md:grid-cols-6 md:gap-4 justify-center">
      <div className="col-span-4 md:p-2 mt-3 rounded-md">
        <div className="flex flex-col justify-center p-2 text-gray-700 rounded-md border-l border-black">
          <div className="flex">
            <p className="mx-2 text-sm p-2 font-semibold dark:text-gray-400">
          ...
          <div className="flex pt-1 md:p-1 flex-wrap md:flex-nowrap uppercase font-sanserif dark:bg-slate-800 rounded-md">
        ...
        <div className="flex flex-wrap md:flex-nowrap justify-center mt-5 p-2">
          <div className="w-full md:w-2/3 p-2 bg-white shadow-sm dark:bg-slate-800 rounded-md dark:text-white">
            <Alldays />
          </div>
          <div className="md:w-1/3 flex md:h-full mt-3 md:mt-0 mx-auto md:mx-2 md:p-1 bg-white shadow-sm dark:bg-slate-800 rounded-md">
            {isLoading ? <Spinner /> : <Piechart datasets={chartsData} />}
          </div>
        </div>
        <div className="flex flex-wrap md:flex-nowrap mt-3">
          <div className="w-full md:mx-2 md:p-8 dark:bg-slate-800 rounded-md shadow-md dark:shadow-gray-900 ">
            <BarGraph id={"all"} />
          </div>
        </div>
